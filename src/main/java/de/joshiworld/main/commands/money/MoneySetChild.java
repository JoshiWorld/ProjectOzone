 ...
 * @author JoshiWorld
 */
public class MoneySetChild implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        if(src instanceof Player) {
            ...
            if(pd.getPermissionValue("projectozone.money").asBoolean()) {
                ...
                Money.setMoney(target.getName(), amount);
                ...
                p.sendMessage(TextSerializers.FORMATTING_CODE.deserialize(Ozone.getPrefix() + " §aDu hast die Rubine von " + prefix + target.getName() + " §aauf §c" + amount + " §agesetzt"));
            }
        }
