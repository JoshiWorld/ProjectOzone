 ...
 * @author JoshiWorld
 */
public class MoneyAddChild implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        if(src instanceof Player) {
            ...
            if(pd.getPermissionValue("projectozone.money").asBoolean()) {
                ...
                Money.addMoney(target.getName(), amount);
                ...
                p.sendMessage(TextSerializers.FORMATTING_CODE.deserialize(Ozone.getPrefix() + " §aDu hast " + prefix + target.getName() + " §c" + amount + " §aRubine hinzugefügt"));
            }
        }
